...
export default function CertificadoICAExportacion() {
  ...
  useEffect(() => {
    ...
    const borradorGuardado = sessionStorage.getItem("borrador_certificado_ica_expo_v1");
    ...
    if (borradorGuardado) {
      ...
      // Si es la primera vez, generamos número de certificado y heredamos datos base de exportación
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("borrador_certificado_ica_expo_v1", JSON.stringify(borradorActual));
  });
  ...
  const generarPDF = (e: React.FormEvent) => {
    ...
    doc.save(`Certificado_ICA_Exportacion_${numeroCertificado}.pdf`);
  };
    ...
    <main className="min-h-screen bg-gray-100 p-4 md:p-8 flex flex-col items-center">
      ...
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-2xl border-t-8 border-green-700 overflow-hidden">
        ...
        <div className="bg-green-50 p-6 border-b border-green-200 flex justify-between items-center">
          <div>
            <h2 className="font-black text-2xl text-green-900 tracking-tight">Certificado Fitosanitario (ICA) - Exportación</h2>
        ...
        <form onSubmit={generarPDF} className="p-8 space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 pt-4">
            ...
            <Link href="/certificado-invima-exportacion" className="flex-1 bg-blue-700 text-white font-bold py-4 rounded shadow-lg hover:bg-blue-800 text-center text-lg border-b-4 border-blue-900 flex items-center justify-center">
