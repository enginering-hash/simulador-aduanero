...
export default function AprobacionCorreo() {
  ...
  useEffect(() => {
    const borradorGuardado = sessionStorage.getItem("borrador_aprobacion_correo");
    ...
    if (borradorGuardado) {
      ...
      const proformaGuardada = sessionStorage.getItem("borrador_factura_proforma");
      if (proformaGuardada) {
  ...
  useEffect(() => {
    if (fechaCorreo) {
      ...
      sessionStorage.setItem("borrador_aprobacion_correo", JSON.stringify(borradorActual));
    }
  });
      ...
      <div className="w-full max-w-6xl bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col md:flex-row border border-gray-200">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <form onSubmit={generarPDF} className="flex-1 flex flex-col p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[100px_1fr] gap-4 items-center border-b border-gray-100 pb-4">
              <label className="text-sm font-bold text-gray-700500">Para:</label>
              <input 
                type="email" 
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200 mt-4">
              ...
              <div className="flex gap-3">
                ...
                <Link href="/formato-reserva" className="bg-emerald-500 text-white font-bold py-3 px-6 rounded-lg shadow hover:bg-emerald-600 transition-colors flex items-center">
                  Siguiente Paso →
                </Link>
              </div>
            </div>
