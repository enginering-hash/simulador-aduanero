...
export default function CertificadoOrigen() {
  ...
  return (
    <main className="min-h-screen bg-gray-100 p-4 md:p-8 flex flex-col items-center justify-center">
      ...
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-2xl border-t-8 border-emerald-600 overflow-hidden p-8 md:p-12">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-emerald-800 uppercase tracking-tight">
          ...
          <div className="w-full bg-gray-50 border border-gray-200 rounded-lg p-6 text-left shadow-inner">
            ...
            <ul className="list-disc pl-5 space-y-3 text-gray-600 text-sm md:text-base">
              <li>Identifica cuál es el país de origen y el país de destino en tu simulación.</li>
          ...
          <div className="w-full pt-6">
            <Link href="/certificado-lote" className="w-full bg-emerald-600 text-white font-black py-5 px-4 rounded-xl shadow-lg hover:bg-emerald-700 transition-all text-lg md:text-xl uppercase tracking-widest border-b-4 border-emerald-800 flex items-center justify-center gap-3">
