...
export default function DocumentoTransporteExportacion() {
  ...
  useEffect(() => {
    // Usamos la variable específica de exportación
    const borradorGuardado = sessionStorage.getItem("borrador_documento_transporte_expo_v1");
    ...
    if (borradorGuardado) {
      ...
      // Heredar datos esenciales de la reserva de EXPORTACIÓN
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("borrador_documento_transporte_expo_v1", JSON.stringify(borradorActual));
  });
